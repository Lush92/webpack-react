...
// instead of loading all our components, we use lazy loading
// w/ lzl , the BookDetails component is loaded only when the user
// goes to that component and not when the user is on homepage
  ...
  render() {
    return (
      <div className='app'>
        ...
        <Route
          path='/details/:bookId'
          component={loadableBookDetails} //lzl
        />
